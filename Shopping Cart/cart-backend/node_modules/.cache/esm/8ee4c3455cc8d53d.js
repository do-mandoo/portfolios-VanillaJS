let mongoose,Joi,Cart,Product;_5cc‍.x([["checkObjectId",()=>checkObjectId],["Pwrite",()=>Pwrite],["Cwrite",()=>Cwrite],["Plist",()=>Plist],["Clist",()=>Clist],["remove",()=>remove],["update",()=>update]]);_5cc‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);_5cc‍.w("joi",[["default",["Joi"],function(v){Joi=v}]]);_5cc‍.w("../../models/cart",[["default",["Cart"],function(v){Cart=v}]]);_5cc‍.w("../../models/product",[["default",["Product"],function(v){Product=v}]]);
...
POST /api/appPosts/mycart/:add
{
  ...
  const result = schema.validate(ctx.request.body);
  _5cc‍.g.console.log(result, 'result dsfdsfdsfds');
  if (result.error) {
    ctx.status = 404; // Bad Request
    ctx.body = result.error;
    return;
  ...
  _5cc‍.g.console.log(cart, '2324cart');
  try {
...
DELETE /api/mycart/delete/:id */
  ...
  const { id } = ctx.params;
  _5cc‍.g.console.log(ctx.params, 'params');
  try {
    await Cart.findOneAndDelete({ cartId: id }).exec();
    const cart = await Cart.find().exec();
    _5cc‍.g.console.log(cart, 'cart311');
    ctx.body = cart;
    _5cc‍.g.console.log(ctx.body, 'ctx.body195843075');
...
PATCH /api/mycart/modify/:id
{
  ...
  _5cc‍.g.console.log({ numberOfCart });
